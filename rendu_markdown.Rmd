...
#    }
#}
route_list_creuse <- readRDS(file = "route_list_creuse.rds")
route_list_lyon <- readRDS(file = "route_list_lyon.rds")
route_list_paris <- readRDS(file = "route_list_paris.rds")
```
...
#    }
#}
route_gh_creuse <- readRDS(file = "route_gh_creuse.rds")
route_gh_lyon <- readRDS(file = "route_gh_lyon.rds")
route_gh_paris <- readRDS(file = "route_gh_idf.rds")
```
...
#                          point_sf_idf,
#                          point_sf_idfb)
route_otp_creuse <- readRDS(file = "route_otp_creuse.rds")
route_otp_lyon <- readRDS(file = "route_otp_lyon.rds")
route_otp_paris <- readRDS(file = "route_otp_idf.rds")
