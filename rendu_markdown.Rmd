...
for (i in 481:length(coord_osrm_paris)) {
...
Then we can setup the routing graph and calculate our itineraries, setting up the cores from where there is our pbf file.
...
and we display the itineraries
